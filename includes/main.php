    ...
    <div class="site-wrap">
      ...
      <div class="page-header__bottomline">
        <div class="container clearfix">
          ...
          <div class="logo">
            <a class="logo__link" href="index.php"><h1>Online Store</h1></a>
          </div>
            ...
            <ul class="categories">
              ...
              <li class="categories__item">
                ...
                <div class="dropdown dropdown--lookbook">
                  <div class="clearfix">
                    <div class="dropdown__heading text-center">Account Settings</div>
                    <div class="dropdown__half">
                      
                      <ul class="dropdown__items text-center">
