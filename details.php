                                ...
                                <div class="item active">
                                    <center>
                                        <img src="admin_area/product_images/<?php echo $pro_img1; ?> "
                                            class="img-responsive" style="height:650px; width:auto; margin-left: auto; margin-right: auto; width: 100%;" >
                                    </center>
                                </div>
...
Product Price : <del> $pro_price vnd</del><br>

Product sale Price : $pro_psp_price vnd
...
Bundle Price : <del> $pro_price vnd</del><br>

Bundle sale Price : $pro_psp_price vnd
                    ...
                    <div class="row" id="thumbs">
                        ...
                        <div class="col-xs-4">
                            ...
                            <a href="#" class="thumb">
                                ...
                                <img src="admin_area/product_images/<?php echo $pro_img1; ?>" class="img-responsive" style="height:240px; weight:auto">
                        ...
                        <div class="col-xs-4">
                            ...
                            <a href="#" class="thumb">
                                ...
                                <img src="admin_area/product_images/<?php echo $pro_img2; ?>" class="img-responsive"style="height:240px; weight:auto">
                        ...
                        <div class="col-xs-4">
                            ...
                            <a href="#" class="thumb">
                                ...
                                <img src="admin_area/product_images/<?php echo $pro_img3; ?>" class="img-responsive" style="height:240px; weight:auto">
...
<?php
    ...
    $product_price = "<del> $pro_price vnd </del>";

    $product_psp_price = "| $pro_psp_price vnd" ;
    } else {

    $product_psp_price = "";

    $product_price = "$pro_price vnd";
    }
...
<div class='col-md-3 col-sm-6 center-responsive' >
    ...
    <div class='product' >
        <a href='$pro_url' >
        <img src='admin_area/product_images/$pro_img1' class='img-responsive'style='height:350px; weight:auto' >
        </a>
        <div class='text' >
            <center>
            ...
            <a href='$pro_url' class='btn btn-danger'><i class='fa fa-shopping-cart'></i> Add To Cart</a>
            </p>
        </div>
    $product_label
    </div>
...
<div class='col-md-3 col-sm-6 center-responsive' >
    ...
    <div class='text' >
        ...
        <p class='buttons'>
            <a href='$pro_url' class='btn btn-default' >View details</a>
            <a href='$pro_url' class='btn btn-primary'><i class='fa fa-shopping-cart'></i> Add to cart</a>
        </p>
    </div>
    $product_label
    </div>
