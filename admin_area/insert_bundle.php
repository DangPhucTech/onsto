...
<textarea name="product_desc" class="form-control ckeditor" rows="15" id="product_desc">
...
<textarea name="product_features" class="form-control ckeditor" rows="15" id="product_features">
...
<textarea name="product_video" class="form-control ckeditor" rows="15">
