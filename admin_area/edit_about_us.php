...
<label class="col-md-3 control-label ckeditor"> About Us Short Description : </label>

<div class="col-md-8">

<textarea name="about_short_desc ckeditor" class="form-control ckeditor" rows="5">
...
<textarea name="about_desc" id="about_desc" class="form-control ckeditor" rows="10">
