...
?>
    ...
    <center>
        ...
        <form action="https://payment.momo.vn" method="post" target="_top">
            ...
            <input type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_buynow_LG.gif" border="0"
                name="submit" alt="Momo - The safer, easier way to pay online!">
            <img alt="" border="0" src="https://test-payment.momo.vn" width="1" height="1">
        </form>
...
?>
        ...
        <input type="image" name="submit" width="580" height="566" src="images/momo.jpg">
